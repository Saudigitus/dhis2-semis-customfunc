...
export type AnalyticsJobParameters = {
    ...
    skipTableTypes: Array<'DATA_VALUE' | 'COMPLETENESS' | 'COMPLETENESS_TARGET' | 'ORG_UNIT_TARGET' | 'EVENT' | 'ENROLLMENT' | 'OWNERSHIP' | 'VALIDATION_RESULT'>;
};
...
export declare namespace AnalyticsTableHook {
    enum analyticsTableType {
...
export declare namespace ApprovalStatusDto {
    enum state {
...
export declare namespace AxisV2 {
    enum type {
        DOMAIN = "DOMAIN",
        RANGE = "RANGE"
    }
...
export declare namespace CategoryCombo {
    enum dataDimensionType {
        DISAGGREGATION = "DISAGGREGATION",
        ATTRIBUTE = "ATTRIBUTE"
    }
...
export declare namespace CategoryOption {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace CategoryOptionCombo {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace CategoryOptionGroup {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace CategoryOptionGroupSet {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace Configuration {
    enum infrastructuralPeriodType {
...
export declare namespace CustomDataEntryFormDto {
    enum displayDensity {
...
export declare namespace DashboardItem {
    enum shape {
        NORMAL = "NORMAL",
...
export declare namespace DataApprovalWorkflow {
    enum periodType {
        BI_MONTHLY = "BiMonthly",
        BI_WEEKLY = "BiWeekly",
        DAILY = "Daily",
...
export declare namespace DataDimensionItem {
    enum dataDimensionItemType {
        INDICATOR = "INDICATOR",
        DATA_ELEMENT = "DATA_ELEMENT",
        DATA_ELEMENT_OPERAND = "DATA_ELEMENT_OPERAND",
        REPORTING_RATE = "REPORTING_RATE",
...
export declare namespace DataElement {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace DataElementGroupSet {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace DataEntryForm {
    enum style {
        COMFORTABLE = "COMFORTABLE",
        NORMAL = "NORMAL",
        COMPACT = "COMPACT",
...
export declare namespace DataIntegrityCheck {
    enum severity {
        INFO = "INFO",
        WARNING = "WARNING",
        SEVERE = "SEVERE",
...
export declare namespace DataIntegrityJobParameters {
    enum type {
        REPORT = "REPORT",
        SUMMARY = "SUMMARY",
        DETAILS = "DETAILS"
...
export declare namespace DataSetNotificationTemplate {
    enum dataSetNotificationTrigger {
...
export declare namespace DataValueAuditDto {
    enum auditType {
        CREATE = "CREATE",
        UPDATE = "UPDATE",
        DELETE = "DELETE",
...
export declare namespace DataValuesDto {
    enum lockStatus {
        LOCKED = "LOCKED",
        APPROVED = "APPROVED",
        OPEN = "OPEN"
...
export declare namespace DateFilterPeriod {
    enum period {
        TODAY = "TODAY",
        YESTERDAY = "YESTERDAY",
...
export declare namespace DimensionalObject {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace Dxf2EventsTrackedentity_Attribute {
    enum valueType {
        TEXT = "TEXT",
        LONG_TEXT = "LONG_TEXT",
        MULTI_TEXT = "MULTI_TEXT",
...
export declare namespace Dxf2EventsTrackedentity_TrackedEntityInstance {
    enum featureType {
        NONE = "NONE",
...
export declare namespace EntityQueryCriteria {
    enum assignedUserMode {
        CURRENT = "CURRENT",
        PROVIDED = "PROVIDED",
        NONE = "NONE",
        ANY = "ANY",
...
export declare namespace ErrorReport {
    enum errorCode {
        E1000 = "E1000",
        E1001 = "E1001",
        E1002 = "E1002",
...
export declare namespace EventQueryCriteria {
    enum assignedUserMode {
        CURRENT = "CURRENT",
        PROVIDED = "PROVIDED",
        NONE = "NONE",
...
export declare namespace EventRepetition {
    enum parent {
        COLUMN = "COLUMN",
        ROW = "ROW",
        FILTER = "FILTER"
...
export declare namespace EventVisualization {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace ExpressionDimensionItem {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace ExternalMapLayer {
    enum imageFormat {
        PNG = "PNG",
        JPG = "JPG"
    }
...
export declare namespace GenericHttpGatewayConfig {
    enum contentType {
...
export declare namespace GistPreferences {
    enum included {
        FALSE = "FALSE",
        TRUE = "TRUE",
        AUTO = "AUTO"
...
export declare namespace GridHeader {
    enum valueType {
        TEXT = "TEXT",
        LONG_TEXT = "LONG_TEXT",
        MULTI_TEXT = "MULTI_TEXT",
...
export declare namespace IdScheme {
...
export declare namespace ImportConflict {
    enum errorCode {
        E1000 = "E1000",
        E1001 = "E1001",
        E1002 = "E1002",
...
export declare namespace ImportReport {
    enum status {
        OK = "OK",
        WARNING = "WARNING",
        ERROR = "ERROR"
...
export declare namespace ImportSummaries {
    enum status {
        SUCCESS = "SUCCESS",
        WARNING = "WARNING",
        ERROR = "ERROR"
...
export declare namespace IncomingSms {
    enum smsencoding {
        ENC7BIT = "ENC7BIT",
        ENC8BIT = "ENC8BIT",
        ENCUCS2 = "ENCUCS2",
...
export declare namespace JobTypeInfo {
    enum jobType {
        DATA_STATISTICS = "DATA_STATISTICS",
        DATA_INTEGRITY = "DATA_INTEGRITY",
        RESOURCE_TABLE = "RESOURCE_TABLE",
...
export declare namespace LegendDefinitions {
    enum strategy {
        FIXED = "FIXED",
...
export declare namespace MapView {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
    ...
    enum organisationUnitSelectionMode {
        SELECTED = "SELECTED",
        CHILDREN = "CHILDREN",
        DESCENDANTS = "DESCENDANTS",
        ACCESSIBLE = "ACCESSIBLE",
...
export declare namespace MetadataExportParams {
    enum defaults {
        INCLUDE = "INCLUDE",
        EXCLUDE = "EXCLUDE"
    }
...
export declare namespace MetadataImportParams {
    enum atomicMode {
        ALL = "ALL",
        NONE = "NONE"
    }
...
export declare namespace MetadataItem {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace MetadataVersion {
    enum type {
...
export declare namespace ObjectValueTypeRenderingOption {
    enum valueType {
        TEXT = "TEXT",
        LONG_TEXT = "LONG_TEXT",
        MULTI_TEXT = "MULTI_TEXT",
...
export declare namespace OptionGroupSet {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace OptionSet {
    enum valueType {
        TEXT = "TEXT",
        LONG_TEXT = "LONG_TEXT",
        MULTI_TEXT = "MULTI_TEXT",
...
export declare namespace OrderCriteria {
    enum direction {
        ASC = "ASC",
        DESC = "DESC",
        IASC = "IASC",
...
export declare namespace OrganisationUnit {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace OrganisationUnitGroup {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace OrganisationUnitGroupSet {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace OrgUnitInfo {
    enum featureType {
        NONE = "NONE",
        MULTI_POLYGON = "MULTI_POLYGON",
        POLYGON = "POLYGON",
...
export declare namespace OrgUnitMergeQuery {
    enum dataApprovalMergeStrategy {
        LAST_UPDATED = "LAST_UPDATED",
        DISCARD = "DISCARD"
    }
    enum dataValueMergeStrategy {
        LAST_UPDATED = "LAST_UPDATED",
        DISCARD = "DISCARD"
    }
}
...
export declare namespace OutboundMessageResponseSummary {
    enum batchType {
        SMS = "SMS",
        EMAIL = "EMAIL",
        HTTP = "HTTP"
...
export declare namespace OutboundSms {
    enum status {
        OUTBOUND = "OUTBOUND",
        SENT = "SENT",
        ERROR = "ERROR",
...
export declare namespace OutlierAnalysis {
...
export declare namespace OutlierDetectionMetadata {
    enum algorithm {
        Z_SCORE = "Z_SCORE",
        MIN_MAX = "MIN_MAX",
...
export declare namespace PotentialDuplicate {
    enum status {
        ALL = "ALL",
        OPEN = "OPEN",
        INVALID = "INVALID",
...
export declare namespace Predictor {
    enum organisationUnitDescendants {
        SELECTED = "SELECTED",
        DESCENDANTS = "DESCENDANTS"
    }
    enum periodType {
...
export declare namespace ProgramIndicator {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace ProgramMessage {
    enum messageStatus {
        SENT = "SENT",
        FAILED = "FAILED",
        SCHEDULED = "SCHEDULED",
...
export declare namespace ProgramNotificationTemplate {
    enum notificationRecipient {
        TRACKED_ENTITY_INSTANCE = "TRACKED_ENTITY_INSTANCE",
        ORGANISATION_UNIT_CONTACT = "ORGANISATION_UNIT_CONTACT",
...
export declare namespace ProgramRuleAction {
    enum programRuleActionEvaluationTime {
...
export declare namespace ProgramRuleVariable {
...
export declare namespace ProgramStage {
    enum featureType {
        NONE = "NONE",
        MULTI_POLYGON = "MULTI_POLYGON",
        POLYGON = "POLYGON",
...
export declare namespace ProgramStageQueryCriteria {
    enum assignedUserMode {
        CURRENT = "CURRENT",
        PROVIDED = "PROVIDED",
        NONE = "NONE",
...
export declare namespace QueryModifiers {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace RelationshipConstraint {
...
export declare namespace SchedulerEntry {
    enum status {
        RUNNING = "RUNNING",
        COMPLETED = "COMPLETED",
        STOPPED = "STOPPED",
...
export declare namespace SchedulerEntryJob {
    enum status {
        RUNNING = "RUNNING",
        COMPLETED = "COMPLETED",
        STOPPED = "STOPPED",
...
export declare namespace SimpleDimension {
    enum parent {
        COLUMN = "COLUMN",
        ROW = "ROW",
        FILTER = "FILTER"
...
export declare namespace SMPPGatewayConfig {
    enum bindType {
        BIND_TX = "BIND_TX",
        BIND_RX = "BIND_RX",
        BIND_TRX = "BIND_TRX"
    }
    enum numberPlanIndicator {
        UNKNOWN = "UNKNOWN",
        ISDN = "ISDN",
        DATA = "DATA",
        TELEX = "TELEX",
...
export declare namespace SMSCommand {
    enum completenessMethod {
...
export type SourceParams = {
    periodTypes: Array<'BI_MONTHLY' | 'BI_WEEKLY' | 'DAILY' | 'FINANCIAL_APRIL' | 'FINANCIAL_JULY' | 'FINANCIAL_NOV' | 'FINANCIAL_OCT' | 'MONTHLY' | 'QUARTERLY' | 'SIX_MONTHLY_APRIL' | 'SIX_MONTHLY_NOV' | 'SIX_MONTHLY' | 'TWO_YEARLY' | 'WEEKLY' | 'WEEKLY_SATURDAY' | 'WEEKLY_SUNDAY' | 'WEEKLY_THURSDAY' | 'WEEKLY_WEDNESDAY' | 'YEARLY'>;
};
...
export declare namespace SqlView {
    enum cacheStrategy {
        NO_CACHE = "NO_CACHE",
        CACHE_1_MINUTE = "CACHE_1_MINUTE",
        CACHE_5_MINUTES = "CACHE_5_MINUTES",
...
export declare namespace StyledObject {
    enum textMode {
        AUTO = "AUTO",
        CUSTOM = "CUSTOM"
    }
...
export declare namespace TestJobParameters {
    enum failWithPolicy {
        PARENT = "PARENT",
        FAIL = "FAIL",
        SKIP_STAGE = "SKIP_STAGE",
...
export declare namespace TrackedEntityAttribute {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace TrackedEntityInstanceFilter {
    enum enrollmentStatus {
        ACTIVE = "ACTIVE",
        COMPLETED = "COMPLETED",
        CANCELLED = "CANCELLED"
...
export declare namespace TrackedEntityType {
    enum featureType {
        NONE = "NONE",
        MULTI_POLYGON = "MULTI_POLYGON",
        POLYGON = "POLYGON",
...
export declare namespace TrackerIdSchemeParam {
    enum idScheme {
        UID = "UID",
        CODE = "CODE",
        NAME = "NAME",
...
export declare namespace TrackerReport_ImportReport {
    enum status {
        OK = "OK",
        WARNING = "WARNING",
        ERROR = "ERROR"
...
export declare namespace TrackerTypeReport {
    enum trackerType {
        TRACKED_ENTITY = "TRACKED_ENTITY",
        ENROLLMENT = "ENROLLMENT",
        EVENT = "EVENT",
...
export declare namespace ValidationNotificationTemplate {
    enum sendStrategy {
        COLLECTIVE_SUMMARY = "COLLECTIVE_SUMMARY",
        SINGLE_NOTIFICATION = "SINGLE_NOTIFICATION"
    }
...
export declare namespace Visualization {
    enum aggregationType {
        SUM = "SUM",
        AVERAGE = "AVERAGE",
        AVERAGE_SUM_ORG_UNIT = "AVERAGE_SUM_ORG_UNIT",
...
export declare namespace WebapiControllerTrackerView_Attribute {
    enum valueType {
        TEXT = "TEXT",
        LONG_TEXT = "LONG_TEXT",
        MULTI_TEXT = "MULTI_TEXT",
...
export declare namespace WebapiControllerTrackerView_Enrollment {
    enum status {
        ACTIVE = "ACTIVE",
        COMPLETED = "COMPLETED",
        CANCELLED = "CANCELLED"
...
export declare namespace WebapiControllerTrackerView_Event {
    enum status {
        ACTIVE = "ACTIVE",
        COMPLETED = "COMPLETED",
        VISITED = "VISITED",
...
export declare namespace WebapiControllerTrackerViewRelationshipItem_Enrollment {
    enum status {
        ACTIVE = "ACTIVE",
        COMPLETED = "COMPLETED",
        CANCELLED = "CANCELLED"
...
export declare namespace WebapiControllerTrackerViewRelationshipItem_Event {
    enum status {
        ACTIVE = "ACTIVE",
        COMPLETED = "COMPLETED",
        VISITED = "VISITED",
...
export declare namespace WebMessage {
    enum errorCode {
        E1000 = "E1000",
        E1001 = "E1001",
        E1002 = "E1002",
